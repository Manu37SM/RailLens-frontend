    ...
    <div className="border-t border-gray-200 bg-white p-4 dark:border-slate-700 dark:bg-slate-900">
      <div className="flex items-center gap-2">
        <input
          ...
          className="flex-1 rounded-lg border border-gray-300 px-4 py-2 text-base transition-colors outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-200 sm:text-sm dark:border-slate-600"
        />
