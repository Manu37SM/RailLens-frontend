...
export default function AssistantDialog({
  ...
  if (!open) return null;
  return (
    <div className="fixed right-6 bottom-24 z-50 flex h-[600px] w-[380px] max-w-[calc(100vw-2rem)] flex-col overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-2xl dark:border-slate-700 dark:bg-slate-900">
