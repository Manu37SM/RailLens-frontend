      ...
      <div className="flex scrollbar-none gap-2 overflow-x-auto pb-2">
        {sortedSearches.map((search) => {
          switch (search.type) {
            case 'train': {
              const content = (
                <div className="flex items-center gap-2 rounded-full border border-slate-200 bg-white px-3 py-1.5 transition hover:border-orange-300 hover:bg-orange-50 dark:border-slate-700 dark:bg-slate-900 dark:hover:border-orange-500/50 dark:hover:bg-orange-500/10">
