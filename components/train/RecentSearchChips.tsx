      ...
      <div className="flex gap-3 overflow-x-auto pb-2">
        {searches.slice(0, 8).map((search) => {
          switch (search.type) {
            case 'train': {
              const content = (
                <div className="flex items-center gap-2 rounded-full border border-slate-200 bg-white px-4 py-2 shadow-sm transition hover:border-orange-300 hover:bg-orange-50">
