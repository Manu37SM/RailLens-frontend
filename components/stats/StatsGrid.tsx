...
import {
  StationTrafficProjection,
  StatsResponse,
  TrainSpeedProjection,
} from '@/types/stats';
  ...
  return (
    <div className="space-y-6">
      <div className="grid gap-4 sm:grid-cols-2">
        <BigNumberCard
          icon={TrainFront}
          label="Trains in the database"
          value={stats.totalTrains}
        />
        <BigNumberCard
          icon={MapPinned}
          label="Stations in the database"
        ...
        {stats.shortestRoute && (
          <Card>
            ...
            <Link
              ...
              className="font-semibold text-slate-900 hover:text-orange-600 dark:text-slate-100"
            >
              {stats.shortestRoute.trainNumber} ·{' '}
              {stats.shortestRoute.trainName}
            </Link>
            <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
        ...
        {stats.busiestStation && (
          <Card>
            ...
            <Link
              ...
              className="font-semibold text-slate-900 hover:text-orange-600 dark:text-slate-100"
            >
              {stats.busiestStation.stationCode} ·{' '}
              {stats.busiestStation.stationName}
            </Link>
            <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
