...
export default function NetworkStatsGrid({ stats }: Props) {
  const summary = [
    ...
    },
    {
      ...
      value: stats.networkDiameter.toLocaleString(),
      icon: Network,
    },
  ];
  return (
    <div className="space-y-8">
      ...
      <Card>
        ...
        <p className="mt-1 text-sm text-gray-500 dark:text-slate-400">
          How stitched-together the network is, computed from the shared-station
          graph across every train&apos;s route.
        </p>
      ...
      <Card>
        ...
        <p className="mt-1 text-sm text-gray-500 dark:text-slate-400">
          Ranked by betweenness centrality - how often a station sits on the
          shortest path between two others in the network&apos;s largest
          connected group.
        </p>
        ...
        <div className="mt-4 overflow-x-auto">
          <table className="w-full text-left text-sm">
            <thead>
              <tr className="border-b border-slate-200 text-gray-500 dark:border-slate-700 dark:text-slate-400">
              ...
              {stats.mostCentralStations.slice(0, 25).map((station, index) => (
                ...
                >
                  ...
                  <td className="py-2 pr-4">
                    {station.betweennessCentrality.toFixed(1)}
                  </td>
                  <td className="py-2 pr-4">
                    {station.closenessCentrality.toFixed(4)}
                  </td>
