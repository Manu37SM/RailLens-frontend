...
function StatCard({
  ...
  return (
    <Card className="flex items-center gap-3">
      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-orange-100 dark:bg-orange-500/15">
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-1.5 rounded-md text-sm font-medium text-slate-500 hover:text-red-600 dark:text-slate-400"
        >
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        ...
        <StatCard
          icon={Route}
          label="Schedule rows"
          value={stats?.totalScheduleRows ?? 0}
        />
      </div>
      ...
      <Card>
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
              Train/station detail lookups and the stats page are cached for up
              to 15 minutes. Writes already clear this automatically - this is a
              manual escape hatch, not something you should need day to day.
            </p>
          </div>
