...
export default async function RankingsPage() {
  ...
  try {
    ...
    rankingsError = err instanceof ApiError ? err.message : 'Failed to load rankings.';
  }
  ...
  return (
    <div className="bg-slate-50 dark:bg-slate-800 py-6">
      <Container>
        ...
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Rankings</h1>
          <p className="mt-2 text-gray-600 dark:text-slate-300">
            Leaderboards computed entirely from the dataset. See{' '}
            <Link href="/achievements" className="text-orange-600 hover:underline">
              Achievements
            </Link>{' '}
