...
export default async function AchievementsPage() {
  ...
  try {
    ...
    achievementsError = err instanceof ApiError ? err.message : 'Failed to load achievements.';
  }
      ...
      <Container>
        ...
        <div className="mb-6">
          ...
          <p className="mt-2 text-gray-600 dark:text-slate-300">
            Top 100 lists and derived awards, computed entirely from the dataset.
          </p>
        </div>
        ...
        {achievements ? (
          ...
          <ErrorState message={achievementsError ?? 'Failed to load achievements.'} />
        )}
      </Container>
    </div>
  );
